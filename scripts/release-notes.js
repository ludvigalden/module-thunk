...
async function main() {
    const res = await got("https://api.github.com/repos/ludvigalden/module-thunk/releases", {
        responseType: "json",
    });
    ...
    // Add compare link
    finalMessage.push(`https://github.com/ludvigalden/module-thunk/compare/${firstVersion}...${lastVersion}`);
